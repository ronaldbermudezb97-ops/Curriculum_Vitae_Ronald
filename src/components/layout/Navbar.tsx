...
export function Navbar() {
  const { isMenuOpen, toggleMenu, activeSection, theme, toggleTheme } = useAppStore()
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg text-secondary hover:text-primary hover:bg-card transition-colors"
